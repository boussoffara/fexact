...
app = typer.Typer(
    name="fisher-acm",
    help="Awesome `fisher-acm` is a Python cli/package created with https://github.com/TezRomacH/python-package-template",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]fisher-acm[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
